		...
		<div class="site-container about-light__container">
			...
			<div class="about-light__grid">
				...
				<div class="about-light__text">
					<p>
						Работаю с PHP, MySQL, HTML, CSS и JavaScript. Делаю сайты, порталы, личные кабинеты и административные разделы, где важны понятная структура и дальнейшая поддержка.
					</p>
					<p>
						В проектах стараюсь держать баланс между аккуратной инженерией и практической скоростью: сначала закрыть реальную задачу, затем оставить код в состоянии, к которому приятно возвращаться.
					</p>
				</div>
			</div>
		</div>
