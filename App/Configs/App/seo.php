...
return [
	...
	'pages' => [
		...
		'blog' => [
			...
			'path' => '/blog/',
			'title' => 'Блог',
			'description' => 'Заметки о видеоиграх, IT, программировании и саморазвитии.',
			'og_title' => 'Блог — Lancy Studio',
			'og_description' => 'Тестовый раздел блога с темами, статьями, рейтингами и комментариями.',
		],
		'certificates' => [
			'label' => 'Сертификаты',
			'path' => '/certificates/',
		...
		'cookies' => [
			...
			'description' => 'Какие файлы cookie использует сайт Lancy Studio, для чего они нужны и как управлять согласием.',
			'og_title' => 'Политика cookie — Lancy Studio',
			'og_description' => 'Описание технических и функциональных cookie сайта: сессия, блог и согласие на использование cookie.',
		],
	],
];
