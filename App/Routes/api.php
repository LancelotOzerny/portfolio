...
$router->post('/api/blog/rubrics/{rubric}/create/', \Controllers\Api\BlogController::class, 'createArticle');
...
$router->addRoute('OPTIONS', '/api/blog/rubrics/{rubric}/create/', \Controllers\Api\BlogController::class, 'options');
